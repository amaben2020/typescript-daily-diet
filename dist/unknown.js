...
function getPerson(id) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getData("/people/1")];
                case 1:
                    person = _a.sent();
...
// fetch util
var getUser = function (url, id) { return __awaiter(void 0, void 0, void 0, function () {
    var data;
    return __generator(this, function (_a) {
        switch (_a.label) {
...
function getSingleUser() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getUser("users", 1)];
                case 1:
                    singleUser = _a.sent();
                    if (singleUser) {
                        //@ts-ignore
                        return [2 /*return*/, singleUser];
                    }
                    return [2 /*return*/, null];
            }
        });
